$(document).ready(function () { 
    ...
    $("#deleteAllMedia").on('submit', (function (e) {
        e.preventDefault();
        ...
        if (!length) {
            ...
            $("#messageBox").html('<p>No record selected please select media.</p>');
            return false;
        }

        $.ajax({
            url: '/media/destroyAll',
            type: 'post',
            ...
            success: function (result) {
                ...
                if (result.status) {
                    ...
                    $("#messageModal").modal('show');
                    $("#messageBox").html('<p>media information  deleted successfully</p>');
                }
