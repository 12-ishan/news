$(document).ready(function () {
      ...
      // alert(strjson);
       ...
       $('#btnOut').on('click', function () {
           ...
           var menuId = $("#menuId").val();
                            ...
                            $("#messageBox").html('<p>Menu Item added successfully.</p>');
    ...
    $("#deleteAllMenu").on('submit', (function (e) {
        e.preventDefault();
        ...
        if (!length) {
            ...
            $("#messageModal").modal('show');
            $("#messageBox").html('<p>No record selected please select menu.</p>');
            return false;
        }
