                        ...
                        <div class="grid-col control-bar">
                            ...
                            <div class="row control">
                                <div class="col-6 left-control">
                                    ...
                                    <button type="button" class="btn btn-flat btn-danger mb-3" onclick="deleteAll('deleteAllMedia','Delete these media\'s details?','Are you sure you want to delete these media\'s details?');">
                                        Delete</button>
                                ...
                                <div class="col-6 right-control">
                                    ...
                                    <a href="{{route('media.create')}}">
                                        <button type="button" class="btn btn-flat btn-secondary mb-3">Add Media</button>
                                    </a>
...
<!--                                 "> -->
                ...
                <form method="post" id="deleteAllMedia">

                    <div class="data-tables">
                        <table id="mediaTable" class="text-center">
                            ...
                            <tbody>
                                ...
                                <tr id="item{{$value->id}}">
                                   ...
                                   <td>@isset($value->name)
                                    <img width="100" height="60" src=" {{ URL::to('/') }}/uploads/media/{{ $value->name }}" alt="image">
                                    @else
                                    NA
                                    @endif</td>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{route('media.edit', $value->id)}}">Edit</a>
                                            <a class="dropdown-item" onclick="deleteRecord('{{$value->id}}','Delete this media details?','Are you sure you want to delete this media details?');">Delete</a>
                                        </div>
                                    </td>
