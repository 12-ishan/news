    ...
    <div class="col-12 mt-5">
        <div class="card">
            <div class="card-body list-grid">
                        ...
                        <div class="grid-col control-bar">
                            ...
                            <div class="row control">
                                <div class="col-6 left-control">
                                    ...
                                    <button type="button" class="btn btn-flat btn-danger mb-3" onclick="deleteAll('deleteAllMediaCategory','Delete these media category\'s details?','Are you sure you want to delete these media category\'s details?');">
                                        Delete</button>
                ...
                <form method="post" id="deleteAllMediaCategory">

                    <div class="data-tables">
                        <table id="mediaCategoryTable" class="text-center">
                                ...
                                <tr id="item{{$value->id}}">
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{route('media-category.edit', $value->id)}}">Edit</a>
                                            <a class="dropdown-item" onclick="deleteRecord('{{$value->id}}','Delete this media category details?','Are you sure you want to delete this media category details?');">Delete</a>
                                        </div>
                                    </td>
