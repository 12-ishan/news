    ...
    <div class="col-12 mt-5">
        <div class="card">
            <div class="card-body list-grid">
                        ...
                        <div class="grid-col control-bar">
                            ...
                            <div class="row control">
                                <div class="col-6 left-control">
                                    ...
                                    <button type="button" class="btn btn-flat btn-danger mb-3" onclick="deleteAll('deleteAllMenu','Delete these Blog\'s details?','Are you sure you want to delete these Menu\'s details?');">
                                        Delete</button>
                                ...
                                <div class="col-6 right-control">
                                    ...
                                    <!-- <a href="{{ url('/console/blog/create') }}"> -->
                                        <button type="button" class="btn btn-flat btn-secondary mb-3">Add Menu</button>
                                    </a>
                ...
                <form method="post" id="deleteAllMenu">

                    <div class="data-tables">
                        <table id="menuTable" class="text-center">
                            ...
                            <tbody>
                                ...
                                <tr id="item{{$value->id}}">
                                    ...
                                    <td>@isset($value->page){{$value->page}}@else NA @endif</td>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('menu.menu-items', $value->id) }}">Item</a>
                                            <a class="dropdown-item" href="{{route('menu.edit', $value->id)}}">Edit</a>
                                            <a class="dropdown-item" onclick="deleteRecord('{{$value->id}}','Delete this Menu details?','Are you sure you want to delete this menu details?');">Delete</a>
                                        </div>
                                    </td>
...
@section('js')
<script src="{{ asset('assets/admin/js/console/menu.js') }}"></script>
@append
