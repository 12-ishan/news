                                ...
                                <tr id="item{{$value->id}}">
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('menu-unit.menu-items', $value->id) }}">Item</a>
                                            <a class="dropdown-item" href="{{route('menu-unit.edit', $value->id)}}">Edit</a>
