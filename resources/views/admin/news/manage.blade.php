                                ...
                                <div class="row control">
                                    <div class="col-6 left-control">
                                        ...
                                        <button type="button" class="btn btn-flat btn-danger mb-3"
                                            onclick="deleteAll('deleteAllNews','Delete these news\'s details?','Are you sure you want to delete these news\'s details?');">
                                            Delete</button>
                            ...
                            <table id="newsTable" class="text-center">
                                ...
                                <tbody>
                                    @foreach ($news as $value)
                                        ...
                                        <td>
                                            @isset($value->category->name){{ $value->category->name }}
                                            @else
                                                NA @endif
                                            </td>
                                            <td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <a class="dropdown-item"
                                                            onclick="deleteRecord('{{ $value->id }}','Delete this news details?','Are you sure you want to delete this news details?');">Delete</a>
                                                    </div>
                                                </td>
                                                </tr>
                                                @endforeach
